...
class FallbackHandler(BaseHandler):
    ...
    async def handle(
        ...
        # Catalogue facts must never be generated by the generic LLM fallback.
        # Product/availability handlers are the only trusted source of product
        # names, prices, sizes, colors and stock.
        catalogue_intents = {
            "product_search",
            "product_inquiry",
            "availability",
        ...
        allow_ai = (
            understanding.intent.value not in catalogue_intents
            and feature_flags.get("enable_ai_responses", False)
